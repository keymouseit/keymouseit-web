// KeyMouse IT V2 — "Solutions We Build" with animated mini input→core→output diagrams.
    ...
    <section className="section band" id="solutions">
      <div className="container">
        <Reveal><SectionHead center maxWidth={680}
          ...
          lead="Every solution follows the same logic — connect inputs, add intelligence, drive outcomes." /></Reveal>
...
Object.assign(window, { SolutionsV2 });
